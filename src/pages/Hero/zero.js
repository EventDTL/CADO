...
const Zero = () => {
  ...
  return (
    <div className="w-full h-auto xl:h-full mt-20">
      <div className="hidden md:block h-[635px] ag:h-[487px] af:h-[570px] xl:h-[850px] ag:mx-2 sm:mx-16 md:mx-32 rounded-3xl mt-4  items-center justify-center">
        {/* Image section */}
        <img
          src="/ORGfullSCR.png"
          alt="Financial advisor"
          className="relative hidden md:block xl:h-[678px] xl:w-[1265px] object-contain xl:top-[-20px] md:h-[440px] md:w-[1265px] md:top-[0px] md:mt-12"
        />
        <img
          src="/activecus.svg"
          alt="Financial advisor"
          className="absolute hidden md:block object-contain md:h-[45px] md:w-[100px] md:bottom-[86px] md:right-[12px] xl:h-[100px] xl:w-[145px] xl:top-[613px] xl:left-[1015px]"
        />
  ...
  <div
    ...
    <div className="flex flex-col items-center md:items-start p-4 md:p-2">
      ...
      <div className="hidden sm:block md:hidden h-[635px] ag:h-[487px] af:h-[570px] xl:h-[850px] ag:mx-2 sm:mx-16 md:mx-32 rounded-3xl mt-4  items-center justify-center ">
        <img
          src="/tabscreen.svg"
          alt="Financial advisor"
          className="relative hidden sm:block md:hidden object-contain sm:h-[515px] sm:w-[610px] sm:top-[20px]"
        />
        <img
          src="/activecus.svg"
          alt="Financial advisor"
          className="absolute hidden sm:block md:hidden object-contain sm:h-[70px] sm:w-[120px] sm:bottom-[114px] sm:right-[86px]"
        />
                <div className="absolute z-10 flex flex-col ag:top-[15px] ag:left-[20px] af:top-[60px] af:left-[35px] ag:w-3/4 aa:top-[30px] aa:left-[50px] xl:top-[100px] xl:left-[80px] sm:top-[90px] sm:left-[45px] md:top-[85px] md:left-[35px]">
  {/* Heading */}
  <h1 className="font-inter text-white font-bold text-left 
  ...
  <div
    ...
    <div className="flex flex-col items-center md:items-start p-4 md:p-2">
      ...
      <div className="block sm:hidden h-[635px] ag:h-[487px] af:h-[570px] xl:h-[850px] ag:mx-2 sm:mx-16 md:mx-32 rounded-3xl mt-4  items-center justify-center ">

        <img
          src="/mobscreen.svg"
          alt="Financial advisor"
          className="relative block sm:hidden object-contain ag:h-[510px] ag:w-[300px] ag:top-[-30px] af:w-[340px] af:top-[25px] aa:h-[530px] aa:w-[360px] aa:top-[8px]"
        />
        <img
          src="/activecus.svg"
          alt="Financial advisor"
