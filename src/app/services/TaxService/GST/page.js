...
export const generateMetadata = () => {
  return {
    ...
    canonical: "https://www.cadhirajostwal.com/services/TaxService/GST",
  };
};
      ...
      <div className={styles.mainContainer} mt-16>
        ...
        <div className={styles.body}>
          <div className={styles.links}>
            <Link href={"/services/TaxService/IncomeTax"}>
              <h2> Income Tax </h2>
            </Link>
          ...
          <div className={styles.blog}>
            <p>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The
              Goods and Services Tax (GST) has revolutionized India&aposs taxation
            ...
            <p>
              ...
              previous month&aposs transactions. The due dates for GST returns vary
              based on the type of return and the taxpayer&aposs category.
            </p>
            ...
            <p>
              ...
              food items, healthcare services, and educational services. It&aposs
            ...
            <div className={styles.unordered2}>
              <ul>
                ...
                <li>Credit of refund to the taxpayer&aposs bank account </li>
              </ul>
            </div>
            <h3>
            ...
            <span>
              ...
              previous month&aposs transactions. Specific due dates vary based on
              the type of return and the taxpayer&aposs category.
            </span>
            <br />
          </div>
          <ModalComponent />
